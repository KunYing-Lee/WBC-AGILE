...
class SceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot = booster_k1.K1_DELAYED_PD_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class ObservationsCfg:
    ...
    class PolicyObservationCfg(ObsGroup):
        ...
        joint_pos = ObsTerm(
            ...
            params={"asset_cfg": SceneEntityCfg("robot", joint_names=booster_k1.K1_JOINT_NAMES, preserve_order=True)},
        )
        joint_vel = ObsTerm(
...
class ActionsCfg:
    ...
    joint_pos = mdp.RelativeJointPositionActionCfg(
        asset_name="robot",
        joint_names=booster_k1.K1_JOINT_NAMES,
        scale=0.1,
        clip={".*": (-1.0, 1.0)},
    ...
    lift = mdp.LiftActionCfg(
        asset_name="robot",
        link_to_lift=booster_k1.LIFT_LINK_NAME,  # Head
        ...
        target_height=booster_k1.DEFAULT_TRUNK_HEIGHT,
...
class RewardsCfg:
    ...
    joint_deviation_l1 = RewTerm(
        ...
        params={
            ...
            "standing_height_threshold": booster_k1.DEFAULT_TRUNK_HEIGHT * 0.8,
            "sensor_cfg": SceneEntityCfg("height_measurement_sensor"),
            "mode": "l1",
        },
    )
    ...
    joint_deviation_l1_upper_body = RewTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg(
                "robot",
                joint_names=booster_k1.ARM_JOINT_NAMES + booster_k1.HEAD_JOINT_NAMES,
            ),
            "standing_height_threshold": booster_k1.DEFAULT_TRUNK_HEIGHT * 0.8,
            "sensor_cfg": SceneEntityCfg("height_measurement_sensor"),
            "mode": "l1",
    ...
    illegal_contacts = RewTerm(
        ...
        weight=-1.0,
        params={
            "sensor_cfg": SceneEntityCfg("contact_forces", body_names=booster_k1.UNDESIRED_CONTACTS_LINKS),
            "threshold": 1.0,
        },
    )
    ...
    feet_distance = RewTerm(
        ...
        weight=-50.0,
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names=booster_k1.FEET_LINK_NAMES),
...
@configclass
class K1StandUpEnvCfg(ManagerBasedRLEnvCfg):
