...
from agile.rl_env.mdp.symmetry import lr_mirror_K1  # noqa: F401
...
@configclass
class K1StandUpPpoRunnerCfg(RslRlOnPolicyRunnerCfg):
    seed = 42
    num_steps_per_env = 24
    max_iterations = 100_000
    save_interval = 250
    experiment_name = "stand_up_k1"
    run_name = "stand_up_k1"
    wandb_project = "StandUp-K1"
