...
class MySceneCfg(InteractiveSceneCfg):
    ...
    robot = booster_k1.K1_LOCOMOTION_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
class TerminationsCfg:
    ...
    illegal_base_height = DoneTerm(
        ...
        params={
            "asset_cfg": SceneEntityCfg("robot", body_names="Trunk"),
            "sensor_cfg": SceneEntityCfg("height_measurement_sensor"),
            "height_threshold": booster_k1.DEFAULT_TRUNK_HEIGHT - 0.3,
        },
    )
...
@configclass
class K1LowerVelocityEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for K1 omnidirectional velocity tracking."""
